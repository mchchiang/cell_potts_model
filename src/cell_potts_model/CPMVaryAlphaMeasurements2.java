...
public class CPMVaryAlphaMeasurements2 implements ThreadCompleteListener {
	...
	public CPMVaryAlphaMeasurements2(
			int nx, int ny, int q,
	...
	public static void main (String [] args){
		...
		new CPMVaryAlphaMeasurements2(nx, ny, q, temp, lambda,
